  ...
  return (
    ...
    >
      <div className="relative h-40 w-full">
        ...
        <div className="absolute right-3 top-3 flex size-7 items-center justify-center rounded-full bg-background/80 backdrop-blur-sm border border-border-strong">
      ...
      <div className="p-5">
        ...
        <p className="mt-1 text-xs text-muted-dim">Você ainda não possui este produto.</p>
      </div>
    </Link>
  );
}
